...
@Repository
public interface WarframeLoadoutRepository
		extends JpaRepository<WarframeLoadout, Long>, JpaSpecificationExecutor<WarframeLoadout> {
	...
	@Query("SELECT wl FROM WarframeLoadout wl LEFT JOIN FETCH wl.skills")
	List<WarframeLoadout> findAllWithSkills();
